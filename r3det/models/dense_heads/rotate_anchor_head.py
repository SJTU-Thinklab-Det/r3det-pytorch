...
from r3det.core import multiclass_nms_rotated, obb2hbb, ranchor_inside_flags


@HEADS.register_module()
class RAnchorHead(BaseDenseHead):
    ...
    def __init__(self,
                 ...
                 train_cfg=None,
                 test_cfg=None):
        super(RAnchorHead, self).__init__()
